...
<div class="block">
    ...
    <input class="button" type="button" name="NewGroupButton" value="{'Export content classes as XML Schema'|i18n( 'design/admin/xmlexport' )}" title="{'Export classes as XML Schema'|i18n( 'design/admin/xmlexport' )}" onclick="window.location={'xmlexport/createxmlschema/'|ezurl( 'single', 'full' )}"/>
</div>
