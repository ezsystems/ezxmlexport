...
<ul>
    <li><div><span class="disabled">{'XML export'|i18n( 'design/admin/parts/setup/menu' )}</span></div></li>
...
<ul>
    <li><div><a href={'/xmlexport/menu/'|ezurl}>{'XML export'|i18n( 'design/admin/parts/setup/menu' )}</a></div></li>
