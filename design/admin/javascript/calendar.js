...
document.write('<div id="fc" style="position:absolute;top:17em;border-collapse:collapse;background:#FFFFFF;border:1px solid #ABABAB;display:none"><table cellpadding=2>');
